...
object Constants {
    ...
    const val DEFAULT_QURAN_PAGE = 1
    const val QURAN_NUMBRE_OF_PAGES = 604

    const val NAVIGATE_FROM_LAST_READING = -1
    const val NAVIGATE_FROM_SEARCH= -2
    ...
    const val LOCATION_SETTING_REQUEST = 100
     ...
     const val INITIAL_FONT_SIZE = 24f
    ...
    const val ISLAMIC_LEAGUE_METHOD = "رابطة العالم الاسلامي"
    const val EGYPTIAN_METHOD = "الطريقة المصرية"
    const val KARACHI_METHOD = "طريقة كاراشي"
    const val UMM_AL_QURA_METHOD = "طريقة أم القرى"
    const val DUBAI_METHOD = "طريقة دبي"
    const val MOON_SIGHTING_COMMITTEE_METHOD = "طريقة لجنة رؤية الهلال"
    const val NORTH_AMERICA_METHOD = "طريقة شمال امريكا"
    const val KUWAIT_METHOD = "طريقة الكويت"
    const val QATAR_METHOD = "طريقة قطر"
    const val SINGAPORE_METHOD = "طريقة سنغفورة"

    val prayerTimesCalculationMethods = listOf(
        ISLAMIC_LEAGUE_METHOD ,
        EGYPTIAN_METHOD ,
        KARACHI_METHOD ,
        UMM_AL_QURA_METHOD ,
        DUBAI_METHOD ,
        MOON_SIGHTING_COMMITTEE_METHOD ,
        NORTH_AMERICA_METHOD ,
        KUWAIT_METHOD ,
        QATAR_METHOD ,
        SINGAPORE_METHOD ,
    )
    ...
    const val SORA_COLLECTION = "surahs"
    const val SERVICE_TAG = "QuranService"
    ...
    const val NOTIFICATION_CHANNEL_ID = "quran"

    ///////////////////////////list of dual mode /////////////////

    val  NAWAWI_HADITH = listOf(
        ...
        "عَنْ أَبِي سَعِيدٍ سَعْدِ بْنِ مَالِكِ بْنِ سِنَانٍ الْخُدْرِيّ رَضِيَ اللهُ عَنْهُ أَنَّ رَسُولَ اللَّهِ صلى الله عليه و سلم قَالَ: \" لَا ضَرَرَ وَلَا ضِرَارَ\" . \nحَدِيثٌ حَسَنٌ، رَوَاهُ ابْنُ مَاجَهْ  فِي \"الْمُوَطَّإِ\" عَنْ عَمْرِو بْنِ يَحْيَى عَنْ أَبِيهِ عَنْ النَّبِيِّ صلى الله عليه و سلم مُرْسَلًا، فَأَسْقَطَ أَبَا سَعِيدٍ، وَلَهُ طُرُقٌ يُقَوِّي بَعْضُهَا بَعْضًا.",
    ...
    val DUAL_LIST = listOf(
        ...
        SurahDualMode(
            reciter = "فارس عباد",
            photo = "https://tvquran.com/uploads/authors/images/%D9%81%D8%A7%D8%B1%D8%B3%20%D8%B9%D8%A8%D8%A7%D8%AF.jpg",
            surahIndex = 15,
            numberOfAyahs = 99,
            surah = "الحجر",
        ...
        SurahDualMode(
            reciter = "الغامدي",
            photo ="https://i1.sndcdn.com/artworks-9JG9m2FfFw6zeMuI-X1JjDA-t500x500.jpg" ,
            surahIndex = 2,
            numberOfAyahs = 286,
            surah = "البقرة",
        ...
        SurahDualMode(
            ...
            photo = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Maher_Al_Mueaqly.png/270px-Maher_Al_Mueaqly.png",
            surahIndex = 18,
            numberOfAyahs = 110,
            surah = "الكهف",
        ...
        SurahDualMode(
            ...
            photo = "https://tvquran.com/uploads/authors/images/%D9%86%D8%A7%D8%B5%D8%B1%20%D8%A7%D9%84%D9%82%D8%B7%D8%A7%D9%85%D9%8A.jpg",
            surahIndex = 36,
            numberOfAyahs = 83,
            surah = "يس",
        ...
        SurahDualMode(
            reciter = "العفاسي",
            photo = "https://i1.sndcdn.com/artworks-000234903922-lo6rs3-t500x500.jpg",
            surahIndex = 12,
            numberOfAyahs = 111,
            surah = "يوسف",
        ...
        SurahDualMode(
            reciter = "نبيل الرفاعي",
            photo ="https://ar.assabile.com/media/photo/full_size/nabil-ar-rifai-2712.jpg" ,
            surahIndex = 39,
            numberOfAyahs = 75,
            surah = "الزمر",
            server = "https://everyayah.com/data/Nabil_Rifa3i_48kbps/"
        )
    )
